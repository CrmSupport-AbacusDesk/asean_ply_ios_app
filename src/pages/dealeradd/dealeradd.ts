...
import { IonicPage, NavController, NavParams, AlertController, ActionSheetController, ToastController, LoadingController, ModalController, Content, Loading } from 'ionic-angular';
...
@IonicPage()
@Component({
  selector: 'page-dealeradd',
  templateUrl: 'dealeradd.html',
})
export class DealeraddPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad DealeraddPage');
    if (this.data.state) {
