  ...
  image:any = 0;
    ...
    getKarigarDetail()
    {
        ...
        .subscribe((r) =>
        {
            ...
            this.image = 0;
            this.karigar_detail1=r['karigar'].partner;
            console.log( this.karigar_detail1);
          

            for (let i = 0; i < this.karigar_detail.image.length; i++) {
                this.image++;
        
                // if( this.getData.image[i] ){
                // }
                
              }
              console.log(this.karigar_detail.image);
    ...
    share_code()
    {
        ...
        this.socialSharing.share("Hey there join me (" + this.karigar_detail.full_name + "-" + this.karigar_detail.mobile_no + ") on Asean Ply, a Plywood app. Enter my code *" + this.karigar_detail.referral_code + "* to earn points back in your wallet!", "Karigar Reffral", image, app_url)
        .then(resp => {
            console.log(resp);
