...
export class CancelpolicyModalPage {
    ...
    tokenInfo:any = {};
    lang:string='';
    constructor(public navCtrl: NavController,public storage:Storage, public navParams: NavParams, public viewCtrl: ViewController,public service:DbserviceProvider,public alertCtrl:AlertController,public loadingCtrl:LoadingController, public translate:TranslateService) {
        this.redeemType = this.navParams.get('redeem_type');
        this.redeemPoint = this.navParams.get('redeem_point');
        console.log("redeem type===>",  this.redeemType)
    ...
    goRegestrationsPage=()=>{
        this.navCtrl.push(ProfilePage,{'data':this.karigar_detail,"mode":'redeem_page','lang':this.lang})
    }
    get_user_lang()
    {
