...
export class OtpPage {
    ...
    submit()
    {
        ...
        .subscribe( (r) =>
        {
            ...
            {
                this.translate.get(`Your account has been suspended Please Contact:	<a href="tel:18005724615">18005724615</a> ` )
                .subscribe(resp=>{
                    this.showAlertSuspend(resp);
                });
            ...
            else if(r['status'] == 'SUCCESS')
            {
                ...
                if( r['user'].status !='Verified' && r['user'].user_type!='4')
                {
