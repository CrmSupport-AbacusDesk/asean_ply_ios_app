...
export class HomePage {
    ...
    getData()
    {
        ...
        .subscribe((r:any)=>
        {
            ...
            this.total_balance_point1 =this.karigar_detail.balance_point;
            console.log(this.total_balance_point1);
            ...
            this.total_calculated_balance = parseInt( this.karigar_detail.balance_point) + parseInt(this.karigar_detail.calculated_balance );
   ...
   viewProfiePic()
    ...
    viewKarigar()
    {
        ...
        this.navCtrl.push(KarigarListPage,{'lang':this.lang})
    }
    ...
    viewDealer()
    {
        ...
        this.navCtrl.push(DealerListPage,{'lang':this.lang})
    }
    viewArchitect()
    {
        console.log(this.lang);
        
        this.navCtrl.push(ArchitectListPage,{'lang':this.lang})
    }
    goOnScanePage(){
    ...
    goRedeemType(){
        this.navCtrl.push(RedeemTypePage,{'mode':'home',"balence_point":this.total_balance_point,"redeem_point":this.total_calculated_balance});
    }
    ...
    share()
    {
        ...
        let image = "";
        let app_url = "https://apps.apple.com/us/app/asean-high-flyer-scheme/id6444904470";
        
        this.socialSharing.share("Hey there join me (" + this.karigar_detail.full_name + "-" + this.karigar_detail.mobile_no + ") on Aseanply, a Plywood app. Enter my code *" + this.karigar_detail.referral_code + "* to earn points back in your wallet!", "Karigar Reffral", image, app_url)
        .then(resp=>{
            console.log(resp);
